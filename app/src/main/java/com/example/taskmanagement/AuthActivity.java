...
public class AuthActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stlogin = (TextView) findViewById(R.id.switch_to_login);
        stsignup = (TextView) findViewById(R.id.switch_to_signup);
        ...
        db.collection("user").document(email)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(AuthActivity.this,"An email has been sent to your gmail, please complete registration",Toast.LENGTH_LONG).show();
                    }
                })
